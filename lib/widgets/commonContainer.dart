...
Widget CommonContainer(String s1, s2, s3, image, bool imageLeft, BuildContext context) {
  return Container(
    color: Colors.white,
    padding: EdgeInsets.symmetric(horizontal: MediaQuery.sizeOf(context).width / 10, vertical: 20),
    child: Row(
      children: [
        imageLeft
            ? Expanded(
...
Widget CommonContainerMobile(String s1, s2, s3, image, bool imageLeft, BuildContext context) {
  return Container(
    padding: EdgeInsets.symmetric(horizontal: MediaQuery.sizeOf(context).width  / 10, vertical: 30),
    child: Column(
